...
// 复位,倒计时
function startcountdown(timer, isOpen = true, prefix = '', callback = null) {
...
//	$(".countdownnum2").css("display", "block");
    ...
    countdowninv = setInterval(function () {
        timer -= 1;
        countdowntimer(timer, isOpen, callback);
...
function winnerpage(results, callback) {
    ...
    }, [results, callback, postMessageToTop]);
}

    ...
    install(Vue, connection, opts = {}) {
        ...
        if (opts.connectManually) {
            Vue.prototype.$connect = (connectionUrl = connection, connectionOpts = opts) => {
                ...
                Vue.prototype.$socketObserver = observer;
            ...
            Vue.prototype.$disconnect = () => {
                ...
                } else if (Vue.prototype.$socketObserver && Vue.prototype.$socketObserver.WebSocket) {
                    const $WebSocket = Vue.prototype.$socketObserver.WebSocket;
